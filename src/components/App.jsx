...
function App() {
  ...
  function NumEnter(Num) {
    Num !== "C" ? setInt((preValue) => preValue + Num) : setInt("");
    Num !== "C" ? setCal((preValue) => preValue + Num) : setCal("");
    Num === "C" && setAns("0");
    Num === "C" && setCal("");
  }
  function OperatorInput(operate) {
    ...
    operate === "x"
      ? setCal((preValue) => preValue + "*")
      : operate === "%"
      ? setCal((preValue) => preValue + "*.01*")
      : setCal((preValue) => preValue + operate);
  }
